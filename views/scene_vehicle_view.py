...
class SceneVehicleView(SceneView):
    def build_ui(self):
        ...
        self.ui.place_scans_auto_btn.connect(self.scene_ctrl.place_scans_auto)
        self.ui.place_scans_manual_btn.connect(self.scene_ctrl.place_scans_manual)
        self.ui.apply_pictures_btn.connect(self.scene_ctrl.apply_pictures)
        self.ui.intensity_point_cloud_btn.connect(self.scene_ctrl.create_point_cloud)
