...
class TabPage(QWidget):
    ...
    def create_layout(self):
        ...
        drone_folder_layout.addWidget(self.drone_folder_button)
        ...
        scans_folder_layout.addWidget(self.scans_folder_button)
        ...
        assets_folder_layout.addWidget(self.assets_folder_button)
